        ...
        public static Color ToColor(this string colorString)
        {
            ...
            if (colorString[0] == '#')
            {
                switch (colorString.Length)
                {
                    case 9:
                        {
                            uint cuint = Convert.ToUInt32(colorString[1..], 16);
                    ...
                    case 5:
                        {
                            ushort cuint = Convert.ToUInt16(colorString[1..], 16);
            ...
            if (colorString.Length > 3 && colorString[0] == 's' && colorString[1] == 'c' && colorString[2] == '#')
            {
                ...
                if (values.Length == 4)
                {
                    double scA = double.Parse(values[0].AsSpan(3), CultureInfo.InvariantCulture);
                ...
                if (values.Length == 3)
                {
                    double scR = double.Parse(values[0].AsSpan(3), CultureInfo.InvariantCulture);
