...
namespace CoreAppUAP.Controls
{
    ...
    /// or vertically.
    /// </summary>
    public sealed partial class StackPanelEx : Panel
    {
        /// <summary>
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            if (fHorizontal)
            {
                ...
                adjustedSize.Height = Math.Max(0.0, adjustedSize.Height - effectiveVerticalPadding);
            }
            else
            {
                adjustedSize.Height = double.PositiveInfinity;
                adjustedSize.Width = Math.Max(0.0, adjustedSize.Width - effectiveHorizontalPadding);
            }

            Size desiredSizeUnpadded = new();
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            Rect arrangeRect = new(leftAdjustment, topAdjustment, adjustedSize.Width, adjustedSize.Height);
